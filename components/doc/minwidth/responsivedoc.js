...
export function ResponsiveDoc(props) {
    ...
    <div class="min-w-min md:min-w-max">responsive min-width</div>
</div>
    `,
            ...
            <div className="card">
                <div className="flex flex-wrap align-items-center justify-content-center card-container yellow-container">
                    <div className="border-round bg-yellow-100 w-20rem p-3 m-3">
                        <div className="min-w-min md:min-w-max border-round bg-yellow-500 text-gray-900 font-bold p-3 flex align-items-center justify-content-center">responsive min-width</div>
                    </div>
                </div>
            </div>
