...
export function StartDoc(props) {
    const code = {
        basic: `<div class="flex align-items-start flex-wrap" style="min-height: 200px">
    <div style="min-width: 200px; min-height: 50px">1</div>
    <div style="min-width: 200px; min-height: 150px">2</div>
    <div style="min-width: 200px; min-height: 100px">3</div>
</div>
    `,
    ...
    <div class="flex align-items-start flex-wrap card-container yellow-container" style="min-height: 200px">
        ...
        <div class="flex align-items-center justify-content-center bg-yellow-500 font-bold text-white border-round m-2" style="min-width: 200px; min-height: 150px">2</div>
        <div class="flex align-items-center justify-content-center bg-yellow-500 font-bold text-white border-round m-2" style="min-width: 200px; min-height: 100px">3</div>
    </div>
</div>
`
    };
