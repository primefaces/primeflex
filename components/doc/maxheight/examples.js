...
export function ExamplesDoc(props) {
    ...
    <div class="h-30rem max-h-full">max-h-full</div>
</div>
    `,
            ...
            <div className="card">
                <div className="flex flex-wrap align-items-center justify-content-center card-container blue-container">
                    <div className="border-round bg-blue-100 w-12rem h-6rem p-3 m-3">
                        <div className="h-30rem max-h-full border-round bg-blue-500 text-white font-bold p-3 flex align-items-center justify-content-center">max-h-full</div>
                    </div>
                </div>
            </div>
