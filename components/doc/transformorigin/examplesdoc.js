...
export function ExamplesDoc(props) {
    const code = {
        basic: `<div>
    <img src="/images/product-placeholder-blue.svg" class="origin-center rotate-45" alt="primeflex">
</div>
<div>
    <img src="/images/product-placeholder-blue.svg" class="origin-top-right rotate-45" alt="primeflex">
</div>
<div>
    <img src="/images/product-placeholder-blue.svg" class="origin-bottom-left rotate-45" alt="primeflex">
</div>
<div>
    <img src="/images/product-placeholder-blue.svg" class=" origin-left rotate-45" alt="primeflex">
</div>
    `,
