...
`
    ...
    return (
        <>
            ...
            <div class="card">
                <div class="flex flex-wrap-reverse md:flex-wrap card-container purple-container" style={{ maxWidth: '500px' }}>
                    <div class="flex align-items-center justify-content-center bg-purple-500 font-bold text-gray-900 m-2 border-round" style={{ minWidth: '200px', minHeight: '100px' }}>
                        1
                    </div>
                    <div class="flex align-items-center justify-content-center bg-purple-500 font-bold text-gray-900 m-2 border-round" style={{ minWidth: '200px', minHeight: '100px' }}>
                        2
