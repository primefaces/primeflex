...
export function ResponsiveDoc(props) {
    const code = {
        basic: `<div class="flex flex-wrap-reverse md:flex-wrap" style="max-width: 500px">
    <div>1</div>
    <div>2</div>
    <div>3</div>
</div>
...
`
    ...
    return (
        <>
            ...
            <div className="card">
                <div className="flex flex-wrap-reverse md:flex-wrap card-container purple-container" style={{ maxWidth: '500px' }}>
                    <div className="flex align-items-center justify-content-center bg-purple-500 font-bold text-gray-900 m-2 border-round" style={{ minWidth: '200px', minHeight: '100px' }}>
                        1
                    </div>
                    <div className="flex align-items-center justify-content-center bg-purple-500 font-bold text-gray-900 m-2 border-round" style={{ minWidth: '200px', minHeight: '100px' }}>
                        2
