            ...
            <div className="card">
                <div className="grid">
                    <div className="col-6 col-offset-3">
                        <div className="text-center p-3 border-round-sm bg-indigo-500 font-bold text-white">6</div>
                    </div>
                </div>

                <div className="grid">
                    <div className="col-4">
                        <div className="text-center p-3 border-round-sm bg-indigo-500 font-bold text-white">4</div>
                    </div>
