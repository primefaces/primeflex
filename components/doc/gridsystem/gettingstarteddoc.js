    ...
    return (
        <>
            ...
            <div className="card">
                <div className="grid">
                    <div className="col">
                        <div className="text-center p-3 border-round-sm bg-blue-500 font-bold text-white">1</div>
                    </div>
                    <div className="col">
                        <div className="text-center p-3 border-round-sm bg-blue-500 font-bold text-white">2</div>
                    </div>
                    <div className="col">
                        <div className="text-center p-3 border-round-sm bg-blue-500 font-bold text-white">3</div>
                    </div>
                </div>
            </div>
