...
export function ResponsiveDoc(props) {
    const code = {
        basic: ` <div>
    <div class="bg-repeat-round md:bg-repeat-space" style="background-image: url('/images/product-placeholder-cyan.svg')"></div>
</div>
    `,
...
`
    ...
    return (
        <>
            ...
            <div className="card">
                <div className="flex align-items-center card-container cyan-container overflow-hidden">
