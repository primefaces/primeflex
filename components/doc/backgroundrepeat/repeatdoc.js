        ...
        <>
            ...
            <div className="card">
                <div className="overflow-hidden">
                    <div className="bg-repeat bg-primary-100 border-primary-500 border-2 border-round w-full" style={{ backgroundImage: "url('/images/product-placeholder-blue.svg')", backgroundSize: '10rem', height: '30rem' }}></div>
                </div>
            </div>
