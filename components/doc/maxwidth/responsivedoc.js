            ...
            <div className="card">
                <div className="flex flex-wrap align-items-center justify-content-center">
                    <div className="border-round bg-primary-100 w-20rem p-3 m-3">
                        <div className="max-w-min md:max-w-max border-round bg-primary font-bold p-3 flex align-items-center justify-content-center">max-w-min on small screen</div>
                    </div>
                </div>
            </div>
