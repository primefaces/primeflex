...
export function ResponsiveDoc(props) {
    ...
    <div class="static bg-primary-100 font-bold border-round p-4" style="min-width: 300px; min-height: 200px;">
        ...
        <>
            ...
            <div className="card">
                <div className="relative md:p-5">
                    <div className="static bg-primary-100 font-bold border-round p-4" style={{ minWidth: '300px', minHeight: '200px' }}>
