        ...
        <>
            ...
            <div className="card">
                <div className="flex flex-column gap-5">
                    <div className="bg-gradient-to-r from-primary-500 h-4rem w-full border-round"></div>
                    <div className="bg-gradient-to-l from-blue-500 to-pink-500 h-4rem w-full border-round"></div>
                    <div className="bg-gradient-to-t from-purple-500 to-cyan-500/60 h-4rem w-full border-round"></div>
                    <div className="bg-gradient-to-b from-green-500/60 to-cyan-400 h-4rem w-full border-round"></div>
                </div>
            </div>
