...
export function VisibleDoc(props) {
    const code = {
        basic: `<div class="overflow-visible" style="height: 100px">
...
`
    ...
    return (
        <>
            ...
            <div className="card">
                <div className="line-height-3 card-container green-container">
                    <div className="overflow-visible surface-overlay p-3 border-green-500 border-2 border-round" style={{ height: '100px' }}>
