        ...
        <>
            ...
            <div className="card">
                <div className="flex align-items-stretch flex-wrap card-container indigo-container" style={{minHeight:'200px'}}>
                    ...
                    <div className="align-self-stretch flex align-items-center justify-content-center bg-indigo-500 font-bold text-white border-round m-2"  style={{ minWidth: '200px', minHeight: '50px' }}>2</div>
