        ...
        <>
            ...
            <div className="card">
                <div className="flex md:align-items-stretch align-items-stretch flex-wrap" style={{ minHeight: '200px' }}>
                    <div className="md:align-self-auto align-self-center flex align-items-center justify-content-center bg-primary font-bold border-round m-2" style={{ minWidth: '200px', minHeight: '50px' }}>
                        1
                    </div>
                    <div className="md:align-self-auto align-self-center flex align-items-center justify-content-center bg-primary font-bold border-round m-2" style={{ minWidth: '200px', minHeight: '50px' }}>
                        2
