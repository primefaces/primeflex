...
export function EndDoc(props) {
    ...
    <div class="align-self-end flex align-items-center justify-content-center bg-primary font-bold text-white border-round m-2" style="min-width: 200px; min-height: 50px">2</div>
        ...
        <>
            ...
            <div className="card">
                <div className="flex align-items-stretch flex-wrap" style={{ minHeight: '200px' }}>
                    ...
                    <div className="align-self-end flex align-items-center justify-content-center bg-primary font-bold text-white border-round m-2" style={{ minWidth: '200px', minHeight: '50px' }}>
                        2
                    </div>
                    <div className="flex align-items-center justify-content-center bg-primary font-bold text-white border-round m-2" style={{ minWidth: '200px', minHeight: '50px' }}>
                        3
