...
export function CenterDoc(props) {
    ...
    <div class="align-self-center" style="min-width: 200px; min-height: 50px">2</div>
    ...
    <div class="flex align-items-stretch flex-wrap card-container green-container" style="min-height: 200px">
        ...
        <div class="flex align-self-center align-items-center justify-content-center bg-green-500 font-bold text-white border-round m-2" style="min-width: 200px; min-height: 50px">2</div>
