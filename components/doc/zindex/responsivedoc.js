        ...
        <>
            ...
            <div className="card">
                <div className="flex flex-wrap justify-content-center" style={{ minHeight: '200px' }}>
                    <div className="z-1 md:z-0 relative flex align-items-center justify-content-center p-4 bg-primary font-bold border-round shadow-1" style={{ width: '100px', height: '100px', left: '25px' }}>
                        1
                    </div>
                    <div className="z-0 relative flex align-items-center justify-content-center p-4 bg-primary font-bold border-round shadow-1" style={{ width: '100px', height: '100px', top: '10px' }}>
                        2
                    </div>
                </div>
            </div>
