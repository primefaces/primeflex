        ...
        <>
            ...
            <div className="card">
                <div className="overflow-hidden">
                    <div className="bg-cover md:bg-contain bg-center bg-no-repeat bg-primary border-round h-20rem w-full" style={{ backgroundImage: "url('/images/product-placeholder-purple.svg')" }}></div>
                </div>
            </div>
