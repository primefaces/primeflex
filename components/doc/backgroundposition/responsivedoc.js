        ...
        <>
            ...
            <div className="card">
                <div className="overflow-hidden flex align-items-center justify-content-center">
                    <div className="bg-top md:bg-bottom bg-no-repeat w-10rem h-10rem bg-primary border-round m-3" style={{ backgroundImage: "url('/images/product-placeholder-yellow.svg')", backgroundSize: '5rem' }}></div>
                </div>
            </div>
