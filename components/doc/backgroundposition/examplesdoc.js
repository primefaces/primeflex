            ...
            <div className="card">
                <div className="card-container blue-container overflow-hidden">
                    <div className="flex flex-wrap align-items-center justify-content-center">
                        ...
                        <div className="bg-right-top bg-no-repeat w-10rem h-10rem bg-blue-500 border-round m-3" style={{ backgroundImage: "url('/images/product-placeholder-blue.svg')", backgroundSize: '5rem' }}></div>
                    </div>
                    <div className="flex flex-wrap align-items-center justify-content-center">
                        <div className="bg-left bg-no-repeat w-10rem h-10rem bg-blue-500 border-round m-3" style={{ backgroundImage: "url('/images/product-placeholder-blue.svg')", backgroundSize: '5rem' }}></div>
                        <div className="bg-center bg-no-repeat w-10rem h-10rem bg-blue-500 border-round m-3" style={{ backgroundImage: "url('/images/product-placeholder-blue.svg')", backgroundSize: '5rem' }}></div>
                        <div className="bg-right bg-no-repeat w-10rem h-10rem bg-blue-500 border-round m-3" style={{ backgroundImage: "url('/images/product-placeholder-blue.svg')", backgroundSize: '5rem' }}></div>
                    </div>
                    <div className="flex flex-wrap align-items-center justify-content-center">
                        <div className="bg-bottom bg-no-repeat w-10rem h-10rem bg-blue-500 border-round m-3" style={{ backgroundImage: "url('/images/product-placeholder-blue.svg')", backgroundSize: '5rem' }}></div>
                        <div className="bg-left-bottom bg-no-repeat w-10rem h-10rem bg-blue-500 border-round m-3" style={{ backgroundImage: "url('/images/product-placeholder-blue.svg')", backgroundSize: '5rem' }}></div>
                        <div className="bg-right-bottom bg-no-repeat w-10rem h-10rem bg-blue-500 border-round m-3" style={{ backgroundImage: "url('/images/product-placeholder-blue.svg')", backgroundSize: '5rem' }}></div>
                    </div>
                </div>
            </div>
