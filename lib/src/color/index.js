...
module.exports = (root, opts) => {
    ...
    const themes = getThemeColors(opts.themes, 'text-', p);
    const surfaces = getColors('surface', 'text-', `${p}-surface-`);
    const whiteAndBlackRgba = getWhiteAndBlackRgbaColors('text-');

    styleClass('color', colors, root, opts, true, true);
    styleClass('color', themes, root, opts, true, true);
    styleClass('color', surfaces, root, opts, true, true);
    styleClass('color', whiteAndBlackRgba, root, opts, true, true);
};
