...
module.exports = (root, opts) => {
    ...
    const themes = getThemeColors(opts.themes, 'bg-', p);
    const surfaces = getColors('surface', 'surface-', `${p}-surface-`);
    const whiteAndBlackRgba = getWhiteAndBlackRgbaColors('bg-');

    styleClass('background-color', colors, root, opts, true, true);
    styleClass('background-color', themes, root, opts, true, true);
    styleClass('background-color', surfaces, root, opts, true, true);
    styleClass('background-color', whiteAndBlackRgba, root, opts, true, true);
};
