...
function getThemeColors(opts = {}, classNamePrefix = '', cssVariablePrefix = '', scopedCssVariable, hasRgba = true) {
    ...
    return Object.keys(themes).length ? Object.values(themes).reduce((acc, theme) => ({ ...acc, ...generate(Object.keys({ ...colors, ...theme.colors })) }), {}) : generate(Object.keys(colors));
}
