...
module.exports = (root, opts) => {
    ...
    const themes = getThemeColors(opts.themes, 'border-', p);
    const surfaces = getColors('surface', 'border-', `${p}-surface-`);
    const whiteAndBlackRgba = getWhiteAndBlackRgbaColors('border-');

    styleClass('border-color', colors, root, opts, true, true);
    styleClass('border-color', themes, root, opts, true, true);
    styleClass('border-color', surfaces, root, opts, true, true);
    styleClass('border-color', whiteAndBlackRgba, root, opts, true, true);
};
