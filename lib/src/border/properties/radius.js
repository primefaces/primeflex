...
module.exports = (root, opts) => {
    ...
    const edges = ['top', 'right', 'bottom', 'left', 'start', 'end'];
    const scales = {
        xs: '0.125rem',
        sm: '0.25rem',
        md: '0.375rem',
    ...
    styleClass(['border-start-start-radius', 'border-end-start-radius'], borderRadiusEdges.start, root, opts, true);
    styleClass(['border-start-end-radius', 'border-end-end-radius'], borderRadiusEdges.end, root, opts, true);
};
