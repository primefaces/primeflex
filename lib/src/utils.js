...
function styleClass(propName, obj, parent, opts, responsive, states) {
    getThemes(opts).always(function (themeName) {
...
function appendRules(root, opts, classNames) {
    getThemes(opts).always(function (themeName) {
        for (const className in classNames) {
            const rule = new Rule({ selector: getSelector(`${className}`, themeName) });
