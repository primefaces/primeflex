...
module.exports = (root, opts) => {
    ...
    const dropShadowProps = {
        'drop-shadow-none': 'drop-shadow(0 0 0 #000000)',
        'drop-shadow-1': 'drop-shadow(0px 3px 5px rgba(0, 0, 0, 0.02)) drop-shadow(0px 0px 2px rgba(0, 0, 0, 0.05)) drop-shadow(0px 1px 4px rgba(0, 0, 0, 0.08))',
        'drop-shadow-2': 'drop-shadow(0px 4px 10px rgba(0, 0, 0, 0.03)) drop-shadow(0px 0px 2px rgba(0, 0, 0, 0.06)) drop-shadow(0px 2px 6px rgba(0, 0, 0, 0.12))',
        'drop-shadow-3': 'drop-shadow(0px 1px 8px rgba(0, 0, 0, 0.08)) drop-shadow(0px 3px 4px rgba(0, 0, 0, 0.1)) drop-shadow(0px 1px 4px -1px rgba(0, 0, 0, 0.1))',
        'drop-shadow-4': 'drop-shadow(0px 1px 10px rgba(0, 0, 0, 0.12)) drop-shadow(0px 4px 5px rgba(0, 0, 0, 0.14)) drop-shadow(0px 2px 4px -1px rgba(0, 0, 0, 0.2))',
        'drop-shadow-5': 'drop-shadow(0px 1px 7px rgba(0, 0, 0, 0.1)) drop-shadow(0px 4px 5px -2px rgba(0, 0, 0, 0.12)) drop-shadow(0px 10px 15px -5px rgba(0, 0, 0, 0.2))',
        'drop-shadow-6': 'drop-shadow(0px 3px 5px rgba(0, 0, 0, 0.06)) drop-shadow(0px 7px 9px rgba(0, 0, 0, 0.12)) drop-shadow(0px 20px 25px -8px rgba(0, 0, 0, 0.18))',
        'drop-shadow-7': 'drop-shadow(0px 7px 30px rgba(0, 0, 0, 0.08)) drop-shadow(0px 22px 30px 2px rgba(0, 0, 0, 0.15)) drop-shadow(0px 8px 10px rgba(0, 0, 0, 0.15))',
        'drop-shadow-8': 'drop-shadow(0px 9px 46px 8px rgba(0, 0, 0, 0.12)) drop-shadow(0px 24px 38px 3px rgba(0, 0, 0, 0.14)) drop-shadow(0px 11px 15px rgba(0, 0, 0, 0.2))'
    };
