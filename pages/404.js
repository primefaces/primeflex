...
const Custom404 = () => {
    return (
        <div className="card flex align-items-center justify-content-center sm:p-8">
            <div className="flex flex-column align-items-center gap-5 pb-6">
                <div className="flex flex-column sm:flex-row align-items-center justify-content-center gap-3 text-primary">
                    <span className="font-bold" style={{ fontSize: '144px', lineHeight: '108px' }}>
                        4
                    </span>
