...
import { ClassesDoc } from '../../components/doc/outlinewidth/classesdoc';
import { ExamplesDoc } from '../../components/doc/outlinewidth/examples';

const OutlineWidthPage = () => {
    const docs = [
        {
            id: 'classes',
            label: 'Classes',
    ...
    return (
        <div>
            <Head>
                <title>Outline Width - PrimeFlex</title>
